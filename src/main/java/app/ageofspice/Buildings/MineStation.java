...
public class MineStation extends absBuilding{
    public static Cost staticBaseCost = new Cost(new AlgiRes(10),new SpiceRes(10),new VibraniumRes(20),new CrystalRes(30));

    public MineStation(ActualPosition newPosition, UnitsStorage playerStorage){
        baseHP = 100;
        actualHP = baseHP;
        buildType = TileType.MINE_STATION;
        baseCost = new Cost(new AlgiRes(10),new SpiceRes(10),new VibraniumRes(20),new CrystalRes(30));
        pos = newPosition;
    }
