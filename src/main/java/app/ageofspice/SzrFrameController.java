...
public class SzrFrameController implements Initializable {
    ...
    public void changePlayer() throws IOException {
        framePane = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("javFrame.fxml")));
        MapController.staticAnchorPane.getChildren().remove(LudFrameController.framePane);
